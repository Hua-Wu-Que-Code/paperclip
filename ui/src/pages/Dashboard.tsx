    ...
    if (companies.length === 0) {
      return (
        <EmptyState
          ...
          message="欢迎使用 Paperclip。请先创建您的第一个公司和智能体以开始使用。"
          action="开始使用"
        ...
        <>
              ...
              <div className="flex items-start gap-2.5">
                ...
                <div>
                  ...
                  <p className="text-xs text-red-100/70">
                    {data.budgets.pausedAgents} 个智能体已暂停 · {data.budgets.pausedProjects} 个项目已暂停 · {data.budgets.pendingApprovals} 个待审批预算
                  </p>
                </div>
              </div>
          ...
          <div className="grid grid-cols-2 xl:grid-cols-4 gap-1 sm:gap-2">
            <MetricCard
              ...
              description={
                <span>
                  {data.agents.running} 个运行中{", "}
                  {data.agents.paused} 个已暂停{", "}
                  {data.agents.error} 个错误
                </span>
              }
            />
            <MetricCard
              ...
              description={
                <span>
                  {data.tasks.open} 个待处理{", "}
                  {data.tasks.blocked} 个已阻塞
                </span>
              }
            />
            <MetricCard
              ...
              description={
                <span>
                  {data.costs.monthBudgetCents > 0
                    ? `已使用预算的 ${data.costs.monthUtilizationPercent}%（共 ${formatCents(data.costs.monthBudgetCents)}）`
                    : "无预算限制"}
                </span>
              }
            />
              ...
              description={
                <span>
                  {data.budgets.pendingApprovals > 0
                    ? `${data.budgets.pendingApprovals} 个预算变更等待审核`
                    : "等待审核"}
                </span>
              }
            />
